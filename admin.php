...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <a href="admin_process.php?admin_listele=1">Listele</a> |
    ...
    <tr>
      ...
      <td>
        <a href="admin_process.php?kurum_rol_listele=1">Listele</a> |
    ...
    <tr>
      ...
      <td>
        <a href="admin_process.php?kayıtlı_kurumlar=1">Listele</a>
        <? if ($k_b_sayisi->rowCount() > 0) { ?>
			| <a href="admin_process.php?kurum_listele=1"><span class="badge btn-danger">Onay Bekleyen Yeni Bir Kurum Var</span></a>
		<? } ?>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <a href="admin_process.php?onaylı_donorler=1">Listele</a>
        <? if ($d_b_sayisi->rowCount() > 0) { ?>
			| <a href="admin_process.php?donor_listele=1"><span class="badge btn-danger">Onay Bekleyen Yeni Bir Donör Var</span></a>
		<? } ?> 
      </td>
    </tr>
<!--
